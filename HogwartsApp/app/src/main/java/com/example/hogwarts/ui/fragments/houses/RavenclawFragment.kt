...
class RavenclawFragment: Fragment() {
    ...
    private var _binding: FragmentRavenclawBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentRavenclawBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        myViewModel.ravenclawLiveData.observe(viewLifecycleOwner) {
            listAdapter.update(it)
        }

        myViewModel.getRavenclawCharacters()
