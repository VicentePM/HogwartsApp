...
import com.example.hogwarts.databinding.FragmentGryffindorBinding
import com.example.hogwarts.ui.MyViewModel

class GryffindorFragment: Fragment() {
    private var _binding: FragmentGryffindorBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentGryffindorBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        myViewModel.gryffindorLiveData.observe(viewLifecycleOwner) {
            listAdapter.update(it)
        }

        myViewModel.getGryffindorCharacters()
