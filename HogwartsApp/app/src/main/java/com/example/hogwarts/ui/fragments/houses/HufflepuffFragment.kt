...
import com.example.hogwarts.databinding.FragmentHufflepuffBinding
...
class HufflepuffFragment: Fragment() {
    ...
    private var _binding: FragmentHufflepuffBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHufflepuffBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        myViewModel.hufflepuffLiveData.observe(viewLifecycleOwner) {
            listAdapter.update(it)
        }

        myViewModel.getHufflepuffCharacters()
